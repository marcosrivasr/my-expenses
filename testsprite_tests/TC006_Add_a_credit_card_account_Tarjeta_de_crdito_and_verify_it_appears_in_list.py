...
async def run_test():
    ...
    try:
        ...
        # -> Click on the 'Cuentas' tab to open the Accounts view (use
        ...
        await page.wait_for_timeout(3000); await elem.fill('Tarjeta Mastercard')

        # -> Fill '2500' into number input placeholder="0.00"
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the 'Agregar' button to add the account and then verify the account appears in the list (check for 'Tarjeta Vis...
        frame = context.pages[-1]
        # Click element
